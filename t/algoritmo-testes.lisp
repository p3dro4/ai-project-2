...
(verificar-igual
  ...
  (cria-no (tabuleiro-jogado) 1 (cria-no (tabuleiro-teste)))
  "cria-no"
)
...
(verificar-igual
  ...
  (no-estado (cria-no (tabuleiro-jogado) 1 (cria-no (tabuleiro-teste))))
  "no-estado"
)
...
(verificar-igual
  1
  (no-profundidade (cria-no (tabuleiro-jogado) 1 (cria-no (tabuleiro-teste))))
  "no-profundidade"
)
...
(verificar-igual
  ...
  (no-pai (cria-no (tabuleiro-jogado) 1 (cria-no (tabuleiro-teste))))
  "no-pai"
)
